...
From there, navigate into the folder titled <b>backend</b> and run <code>rails s</code>. In a second terminal tab, navigate to<b>frontend</b> and run <code>lite-server</code>.<br><br>
